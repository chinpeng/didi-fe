(function(window, undefined) {
    ...
    var util = {
        ...
        genIcon: function(opts) {
            var res = "";
            opts.icon = opts.icon || {};
            var w = opts.icon.width || "28px",
                h = opts.icon.height || "26px",
    ...
    Dialog.fn = Dialog.prototype = {
        ...
        init: function(opts) {
            ...
            if (Object.prototype.toString.call(opts, null) === '[object HTMLDivElement]') {
                div_wall.style.cssText = "position:absolute;left:0;top:0;display:none;z-index:9998;background-color:#000;opacity:0.3";
                div_wrap.style.cssText = "z-index:9999;display:inline-block;position:absolute;border-radius:5px;padding:0;width:280px;background-color:#fff;";
